...
public class DeepslateSteelOreFeature extends OreFeature {
	public static DeepslateSteelOreFeature FEATURE = null;
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("warped_forest"), new ResourceLocation("warm_ocean"),
			...
			new ResourceLocation("flower_forest"), new ResourceLocation("lush_caves"), new ResourceLocation("bamboo_jungle"),
			new ResourceLocation("lukewarm_ocean"), new ResourceLocation("dark_forest"), new ResourceLocation("meadow"),
			new ResourceLocation("old_growth_spruce_taiga"), new ResourceLocation("savanna_plateau"), new ResourceLocation("basalt_deltas"),
			new ResourceLocation("dripstone_caves"), new ResourceLocation("taiga"), new ResourceLocation("crimson_forest"),
	...
	private static class DeepslateSteelOreFeatureRuleTest extends RuleTest {
		static final DeepslateSteelOreFeatureRuleTest INSTANCE = new DeepslateSteelOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<DeepslateSteelOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec
				.unit(() -> INSTANCE);
		private static final RuleTestType<DeepslateSteelOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("nei:deepslate_steel_ore_match"), CUSTOM_MATCH);
		}
