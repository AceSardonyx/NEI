...
public class ThePlaceThatGlowsLeaveDecorator extends LeaveVineDecorator {
	public static final ThePlaceThatGlowsLeaveDecorator INSTANCE = new ThePlaceThatGlowsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("the_place_that_glows_tree_leave_decorator");
