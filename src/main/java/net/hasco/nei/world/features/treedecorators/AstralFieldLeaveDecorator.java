...
public class AstralFieldLeaveDecorator extends LeaveVineDecorator {
	public static final AstralFieldLeaveDecorator INSTANCE = new AstralFieldLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("astral_field_tree_leave_decorator");
