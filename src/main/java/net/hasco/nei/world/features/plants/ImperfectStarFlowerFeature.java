...
public class ImperfectStarFlowerFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("nei:imperfect_star_flower", FEATURE, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
				new SimpleBlockConfiguration(BlockStateProvider.simple(NeiModBlocks.IMPERFECT_STAR_FLOWER.get())), List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("nei:imperfect_star_flower", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),
