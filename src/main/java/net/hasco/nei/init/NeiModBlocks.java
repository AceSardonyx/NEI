...
import net.hasco.nei.block.AcientPortalFrameBlock;
...
public class NeiModBlocks {
	...
	public static final RegistryObject<Block> ACIENT_PORTAL_FRAME = REGISTRY.register("acient_portal_frame", () -> new AcientPortalFrameBlock());
