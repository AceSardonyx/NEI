...
public class NeiModItems {
	...
	public static final RegistryObject<Item> STAR_FLOWER = block(NeiModBlocks.STAR_FLOWER, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> ASTRAL_WATCHER = REGISTRY.register("astral_watcher_spawn_egg",
			() -> new ForgeSpawnEggItem(NeiModEntities.ASTRAL_WATCHER, -1, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> ACIENT_PORTAL_FRAME = block(NeiModBlocks.ACIENT_PORTAL_FRAME, NeiModTabs.TAB_NEI);
	public static final RegistryObject<Item> ASTRAL_SWORD_BETA = REGISTRY.register("astral_sword_beta", () -> new AstralSwordBetaItem());
	public static final RegistryObject<Item> GOLDEN_FLOWER = block(NeiModBlocks.GOLDEN_FLOWER, CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Item> IMPERFECT_STAR_FLOWER = block(NeiModBlocks.IMPERFECT_STAR_FLOWER, CreativeModeTab.TAB_DECORATIONS);
