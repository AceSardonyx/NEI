package net.hasco.nei.block.entity;
...
public class TestDog1BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(30, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TestDog1BlockEntity(BlockPos position, BlockState state) {
		super(NeiModBlockEntities.TEST_DOG_1.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("test_dog_1");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new TestDogGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
