...
public class WitherRoseRightClickedWithUnshapedParticlesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(NeiModItems.PARTICLES.get())) : false) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == NeiModBlocks.IMPERFECT_STAR_FLOWER.get()) {
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(NeiModItems.PARTICLES.get());
				...
				if (entity instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(new TextComponent("You Feel A Slight Breeze..."), (true));
			}
		}
	}
}
