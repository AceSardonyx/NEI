...
public class InformationNEIScreen extends AbstractContainerScreen<InformationNEIMenu> {
	private final static HashMap<String, Object> guistate = InformationNEIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public InformationNEIScreen(InformationNEIMenu container, Inventory inventory, Component text) {
