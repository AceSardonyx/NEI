...
package net.hasco.nei.fluid.attributes;
...
public class PhelliumFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, PhelliumFluidAttributes::new);
	}
	...
	protected PhelliumFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
