...
import net.hasco.nei.fluid.attributes.PhelliumFluidAttributes;
...
public abstract class PhelliumFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(NeiModFluids.PHELLIUM,
			...
			PhelliumFluidAttributes.builder(new ResourceLocation("nei:blocks/water"), new ResourceLocation("nei:blocks/water")).luminosity(1)
